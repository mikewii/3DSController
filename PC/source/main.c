...
int WINAPI WinMain(HINSTANCE hInst, HINSTANCE hPrevInst, LPSTR lpCmd, int nShow)
{
	...
	while(1) {
        ...
        keyboardActive = buffer.packetHeader.keyboardActive;
		
        switch (buffer.packetHeader.command) {
        case CONNECT:
        {
            lastKeys = 0;
            currentKeys = 0;
            ...
            buffer.packetHeader.command = CONNECT;
        ...
        case KEYS:
        {
            ...
            currentKeys     = buffer.keysPacket.keys;
            circlePad       = buffer.keysPacket.circlePad;
            currentTouch    = buffer.keysPacket.touch;
            cStick          = buffer.keysPacket.cStick;
